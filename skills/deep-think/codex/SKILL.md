...
# Deep Think For Codex

Use this packaging artifact when Deep Think should run inside Codex as a
...
- The installed skill runs with plain `python3`.
- `render` language preference is set once at run creation and only affects the
  final render stage.
