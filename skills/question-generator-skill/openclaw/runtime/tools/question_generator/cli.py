...
def build_workflow_parser() -> argparse.ArgumentParser:
    ...
    run_parser.add_argument("--executor-backend", default="codex", choices=["codex", "openclaw"])
    ...
    recipe_on_run_parser.add_argument("--executor-backend", default="codex", choices=["codex", "openclaw"])
